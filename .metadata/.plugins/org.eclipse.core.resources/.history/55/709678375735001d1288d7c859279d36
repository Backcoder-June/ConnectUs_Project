...
<form action="http://localhost:8090/registerBoard" method="post" enctype="multipart/form-data">
...
<tr><th>오너</th><td><input type="text" name="userId" value="세션ID" readonly > </td></tr>
</table>
